...
export default function RegistrationModalProfessional({ isOpen, setIsOpen }: RegistrationModalProps) {
            ...
            <div className="relative z-10 my-4 flex items-center justify-center min-h-screen py-4">
                ...
                <div className="relative w-full max-w-md rounded-lg bg-white shadow-xl animate-in fade-in zoom-in duration-300 overflow-hidden max-h-[90vh] flex flex-col">
                    ...
                    <div className="bg-[#1e3a8a] text-white p-5 relative shrink-0">
                        ...
                        <h3 className="text-lg font-medium">Crear una cuenta profesional</h3>
                    ...
                    <div className="p-5 overflow-y-auto">
                        {submitSuccess ? (
                            <div className="text-center py-6">
                                ...
                                <h3 className="text-xl font-medium mb-2 text-[#1e3a8a]">¡Registro Profesional Exitoso!</h3>
                                <p className="text-gray-600 mb-6">Tu cuenta profesional ha sido creada correctamente.</p>
                                <button
                                    onClick={() => handleClose()}
